...
ifndef CS240LX_2024_PATH
$(error CS240LX_2024_PATH is not set: this should contain the absolute path to where this directory is.  Define it in your shell's initialiation.  For example, .tcshrc for tcsh or .bashrc for bash)
endif
...
OD  = $(ARM)-objdump
OCP = $(ARM)-objcopy
CS240LX_2024_LIBPI_PATH = $(CS240LX_2024_PATH)/libpi
LPP = $(CS240LX_2024_LIBPI_PATH)
LPI ?= $(LPP)/libpi.a
...
CFLAGS += -D__RPI__ $(OPT_LEVEL) -Wall -nostdlib -nostartfiles -ffreestanding -mcpu=arm1176jzf-s -mtune=arm1176jzf-s  -std=gnu99 $(INC) -ggdb -Wno-pointer-sign  -Werror  -Wno-unused-function -Wno-unused-variable -ffunction-sections -fdata-sections -Wl,--gc-sections
